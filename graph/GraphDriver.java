...
public class GraphDriver {
    ...
    public static void test3(Graph g, String startFrom) {
        ...
        System.out.println("starting from: "+ld.get(ld.size()-1));
    ...
    public static void test4(String printGraph) {
        ...
        TopoSearch look = new TopoSearch(g);
        List<Vertex> lt = look.traversalOrder; // this list from your Topological Sort of graph g;
