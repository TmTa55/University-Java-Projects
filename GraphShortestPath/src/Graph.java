...
public abstract class Graph {
     ...
     */
    Map<String,Vertex.VertexState> stateMap = new HashMap<>(150);
    HashMap<Vertex,HashMap<Vertex,Integer>> adjacencyMatrix = new HashMap<>(150);
    SortedMap<Integer, Vertex> VList = new TreeMap<>();
    HashMap<Vertex, Integer> degreeList = new HashMap<>(150);
     ...
     * @param w vertex w of the edge
     */
    abstract void addEdge(Vertex v, Vertex w, int weight);
